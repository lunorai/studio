...
const DEFAULT_TOOLBAR =
  "actions columns filters ordering label-button loading-possum error-box | export-my-annotations refresh import-button export-button grid-size view-toggle";
